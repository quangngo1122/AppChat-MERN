// component tái use: hiện profile bản thân hoặc bạn bè
...
const ProfileCard = ({ user }: ProfileCardProps) => {
  ...
  // trong mảng online có chứa user này thì giá trị của isonline sẽ true còn lại false
  ...
  return (
    ...
    <Card className="overflow-hidden p-0 h-42 bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500">
      <CardContent className="mt-10 pb-8 flex flex-col sm:flex-row items-center sm:items-end gap-6">
