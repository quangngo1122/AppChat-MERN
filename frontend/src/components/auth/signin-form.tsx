...
type SignInFormValues = z.infer<typeof signInSchema>; // typeof--> lay kdl cua signInSchema, infer --> đọc đoạn zod rồi tự suy ra kdl cua form

export function SigninForm({
  className,
  ...props
}: React.ComponentProps<"div">) {
  const { signIn } = useAuthStore(); // useAuthStore.signIn
  ...
  const onSubmit = async (data: SignInFormValues) => {
    ...
    // goi api signIn backend từ store
